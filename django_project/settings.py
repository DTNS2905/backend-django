...
SECRET_KEY = "django-insecure-gm_uc6af#&qu(@3&d7(cn#w9usanwl%%nlfpc+jf^@5n&yv!c3"

AUTH_USER_MODEL = "Innovative_project.User"
...
INSTALLED_APPS = [
    "django_project",
    "Innovative_project.apps.InnovativeProjectConfig",
    "jazzmin",
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Room",
    # Copyright on the footer
    "copyright": "Room Ltd",
    # List of model admins to search from the search bar, search bar omitted if excluded
    # If you want to use a single search field you dont need to use a list, you can use a simple string
    "search_model": ["Innovative_project.User"],
    ...
    "icons": {
        ...
        "django_apscheduler.djangojob": "fas fa-calendar",
        "django_apscheduler.djangojobexecution": "fas fa-calendar-alt",
    },
